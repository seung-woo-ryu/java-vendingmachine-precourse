...
## 물품
- [x] 유효성 검사
  - 상품 가격 100원 부터 시작, 10원으로 나누어 떨어져야 한다.

## 자판기 앱
- [ ] 투입 금액으로 상품 구매
- [X] 잔돈
  - [X] 잔돈 돌려줄 때 최소 개수 '동전’으로 돌려주기
  - [ ] “남은 금액”이 상품 최저 가격보다 적거나, 모든 상품이 소진되면 잔돈 돌려주기
  - [X] 잔돈을 반환할 수 없는 경우 잔돈으로 반환할 수 있는 금액만 반환. 반환못한 금액은 자판기에
